...
import { DAILY_POOL } from '@/lib/data/questions';
...
export default function DailyPage() {
  ...
  const question = sliders[hashStr(today) % sliders.length];
  ...
  const globalAgreePct = 35 + (hashStr(question.id) % 31); // believable 35–65%
